    ...
    public void startRecord(Context context, String voiceName) {
        ...
        if (FileUtils.hasSdcard()) {
            try {
                ...
                e1.printStackTrace();
                Toast.makeText(context, "麦克风不可用",Toast.LENGTH_LONG).show();
            }
            ...
            Toast.makeText(context, "无内存卡,该功能暂时无法使用", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void playRecorder(Context context, String voicePath) {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                // 不存在语音文件
                Toast.makeText(context, "声音文件不存在", Toast.LENGTH_LONG).show();
            }
