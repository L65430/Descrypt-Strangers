...
import com.example.administrator.finalprocject.Utils.PictureUtil;
...
public class PersonalInfoActivity extends Activity {
    ...
    {
        tv_nickname.setText(ClientManger.clientName);
        tv_sex.setText(ClientManger.clientSex);
        tv_birth.setText(ClientManger.clientBirthday);
        tv_signatrue.setText(ClientManger.personSignature);
        //设置头像
        iv_photohead.setImageURI(Uri.fromFile(new File(StaticValues.USER_HEADPATH+ClientManger.clientEmail+".png")));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_nick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PersonalInfoActivity.this,NicknameEditActivity.class );
        ...
        rl_sex.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PersonalInfoActivity.this,SexEditActivity.class);
                startActivity(intent);
            }
        });
        //修改生日
        ...
        //修改签名
        rl_signatrue=(RelativeLayout)findViewById(R.id.personal_rl_signatrue1);
        rl_signatrue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PersonalInfoActivity.this,SignatureEditActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Uri uritempFile = Uri.parse("file://" + "/" + Environment.getExternalStorageDirectory().getPath() + "/" + "small2.jpg");
...
//				}
                        ...
                        ImageUtil.getInstance().saveImage(PersonalInfoActivity.this,
                                headBytes, headPath);
                        // 在主界面左侧栏也要修改头像
                        MainActivity.refreshPinfo(CSKeys.RESET_HEAD, headPath);
    ...
    private String getCharacterAndNumber()
    {
       String rel="";
        ...
        rel=simpleDateFormat.format(date);
        return rel;
    }
