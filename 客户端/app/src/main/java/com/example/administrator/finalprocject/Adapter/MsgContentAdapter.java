...
import com.example.administrator.finalprocject.Activity.ChatActivity;
import com.example.administrator.finalprocject.Activity.MainActivity;
import com.example.administrator.finalprocject.Activity.PersonalInfoActivity;
...
import com.example.administrator.finalprocject.Utils.AnimatedGifDrawable;
import com.example.administrator.finalprocject.Utils.AnimatedImageSpan;
import com.example.administrator.finalprocject.Utils.FaceConversionUtil;
import com.example.administrator.finalprocject.Utils.FaceManager;
...
import com.example.administrator.finalprocject.View.GifTextView;
...
public class MsgContentAdapter extends BaseAdapter {
    ...
    private void handleBaseMessage(ViewHolderBase holder,final JSONObject mItem,final boolean isGetted)
    {
        ...
        {
            String headpath=StaticValues.USER_HEADPATH+ ClientManger.clientEmail+".png";//自己发送的
            holder.head.setImageURI(Uri.fromFile(new File(headpath)));
        }
                ...
                if(isGetted)
                {
                    if(ChatActivity.isgroupMsg)
                    {
                        ...
                        if(ClientManger.isOnline)
                        {
                            ...
                            intent.putExtra("frendInfo",MainActivity.mp1.getfriendinfo(friendId) );
